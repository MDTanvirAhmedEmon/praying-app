    ...
    return (
        <div className="w-full h-full flex justify-between items-center relative">
            ...
            <div className="flex items-center gap-8 mr-10">
                ...
                <Avatar onClick={ () => setShowNotification(!showNotification)} className=" cursor-pointer" style={{ backgroundColor: "#5A015E" }} size={55} icon={<Badge size="small" count={5}><HiOutlineBell className="h-7 w-7 text-white" /></Badge>} />
